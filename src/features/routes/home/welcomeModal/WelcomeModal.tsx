            ...
            {open && page == 3 &&
                <Box sx={{ position: 'fixed', top: 0, right: 0, left: 0, height: "-webkit-fill-available", zIndex: 2000, pointerEvents: "none" }} >
                    <Container maxWidth="md" sx={{ my: 0, height: "100vh", px: 0, position: "relative", pl: { md: "120px", lg: "250px" } }}>
                        <Fab id="createTutorial-button" sx={{ bottom: { md: 200, xs: "25vh" }, position: "absolute", pointerEvents: "auto", right: 30, backgroundColor: "#2e7d32 !important" }} color="primary" aria-label="add">
                            <AddIcon />
                        </Fab>
                        <ButtonArrow />
                    </Container>
