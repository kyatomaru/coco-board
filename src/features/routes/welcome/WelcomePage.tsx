...
import { Box, Typography, Button, CardMedia, Stack, IconButton } from '@mui/material';
            ...
            <Box sx={{ backgroundColor: "rgba(0, 0, 0, 0.4)", position: "absolute", top: 0, right: 0, width: "100%", height: "100%" }} />
                <Box sx={{ height: { xs: 460, md: 500, lg: 540 }, ml: { md: 10, lg: 30 }, zIndex: 1300, position: "relative" }}>
                    <Box sx={{ px: { xs: "10px", md: "20px" }, textAlign: { xs: "center", md: "unset" } }}>
                        ...
                        <Box>
                            <Button component="a" href="https://cocoboard.jp/note" target="_blank" size="large" variant="contained"
                ...
                <Box sx={{ position: "relative", zIndex: 1200, background: "white", width: "100%", mt: 5, px: { xs: "10px", md: "20px" } }} >
                    ...
                    <Box sx={{  py: 7, px: { xs: 0, md: 3 }, maxWidth: 1000, margin: "auto"}}>
                        <Typography sx={{ fontSize: { xs: 20, md: 30 }, mb: 3, color: mainColor, textAlign: "center" }}>機能について</Typography>
                        <Box sx={{ display: "flex", justifyContent: "flex-start", flexDirection: { xs: "column", md: "row" }, gap: { xs: "100px", md: 2 }}}>
                            <Box sx={{ width: { xs: "100%", md: 380}, textAlign: "center", mx: "auto", display: "flex", flexDirection: { xs: "column" }, alignItems: { xs: "center", md: "flex-start" }, justifyContent: "flex-start", gap: { xs: 0, md: 2 }}}>
                                <Box sx={{ display: "flex", flexDirection: "column", alignItems: "flex-start", mx: { xs: 2, md: "auto" }}}>
                                    <Typography sx={{ fontSize: { xs: 14, md: 20 }, mb: 2, fontWeight: 600, color: mainColor }}>1. アニメーション作成</Typography>
                                    <Typography sx={{ color: "#666", fontWeight: 600, fontSize: { xs: 13, md: 14 }, textAlign: "left" }}>
                                        選手や監督は戦術のアニメーションを作成できます
                                    </Typography>
                                    <Typography sx={{ color: "#666", fontWeight: 600, fontSize: { xs: 13, md: 14 }, textAlign: "left" }}>
                                        ドラッグ&ドロップで簡単に操作できます
                                    </Typography>
                            ...
                            <Box sx={{ width: { xs: "unset", md: 380}, textAlign: "center", mx: "auto", display: "flex", flexDirection: { xs: "column" }, alignItems: { xs: "center", md: "flex-start" }, justifyContent: "flex-start", gap: { xs: 0, md: 2 }}}>
                                <Box sx={{ display: "flex", flexDirection: "column", alignItems: "flex-start", mx: { xs: 2, md: "auto" }}}>
                                    <Typography sx={{ fontSize: { xs: 14, md: 20 }, mb: 2, fontWeight: 600, color: mainColor }}>2. LINEで共有</Typography>
                                    <Typography sx={{ color: "#666", fontWeight: 600, fontSize: { xs: 13, md: 14 }, textAlign: "left"  }}>
                                        作成した戦術やフォーメーションをLINEで共有できます
                                    </Typography>
                                    <Typography sx={{ color: "#666", fontWeight: 600, fontSize: { xs: 13, md: 14 }, textAlign: "left"  }}>
                                        試合の振り返りや戦術をチームで共有できます
                                    </Typography>
                                </Box>
