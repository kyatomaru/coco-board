                ...
                <Box sx={{ p: "0 20px", textAlign: { xs: "center", md: "unset" } }}>
                    <Box sx={{ pt: { xs: "200px", md: "150px" }, }}>
                        <Typography variant="h1" sx={{
                            color: "aliceblue", fontSize: { xs: 28, md: 45, lg: 54 },
                            mb: 1
                        }}>サッカーノートアプリ</Typography>
                        <Typography variant="h2" sx={{
                            color: "aliceblue", fontSize: { xs: 18, md: 27, lg: 36 },
                            mb: 1
                        }}>戦術・試合・練習をスマホで記録</Typography>
                    </Box>
                    <Box>
                        <Button onClick={() => router.push('/welcome')} size="large" variant="contained"
            ...
            <Box sx={{ zIndex: 1200, background: "white", width: "100%", mt: 5 }} >
                <Box sx={{ width: "100%", backgroundColor: "#f2f2f2" }}>
                    <Box sx={{ textAlign: "center", py: 10, maxWidth: 450, margin: "auto" }}>
                        <Typography sx={{ fontSize: 23, mb: 3, mx: 3, fontWeight: 500, color: mainColor }}>記録はサクッと3分</Typography>
                        <Typography sx={{ px: 2, color: "#666", fontWeight: 600, fontSize: 14 }}>
                            フォーマットに沿って簡単に記録することで、短時間で効率よく記録が残せます。
                        </Typography>
                        <Stack direction="row" spacing={1} sx={{ mx: 1, mt: 3 }}>
                            <Box sx={{ maxWidth: 210, mx: "auto" }}>
                                <CardMedia
                                    component='img'
                                    image="/images/welcomePage/note1.png"
                                    sx={{}}
                                />
                            ...
                            <Box sx={{ maxWidth: 210, mx: "auto" }}>
                                <CardMedia
                                    component='img'
                                    image="/images/welcomePage/note2.png"
                                    sx={{}}
                                />
                    ...
                    <Box sx={{ textAlign: "center", py: 10, maxWidth: 450, margin: "auto" }}>
                        ...
                        <Typography sx={{ px: 3, color: "#666", fontWeight: 600, fontSize: 14 }}>
