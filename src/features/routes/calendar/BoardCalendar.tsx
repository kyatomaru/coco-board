...
export default function BoardCalendar({ user, selectedMonth, setSelectedMonth, contents }: PageProps) {
                        ...
                        <>
                            ...
                            {days.map((day, index) => (
                                <Grid item xs={12 / 7} key={index} sx={{
                                    ...
                                    >
                                        <Box sx={{ width: "22px", height: "15px", display: "flex", borderRadius: "15px", mt: "1px" }}>
