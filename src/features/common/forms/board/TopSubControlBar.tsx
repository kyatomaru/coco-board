    ...
    return (
        <>
            {isPlay ?
                ...
                :
                <Stack height="25px" direction="row" justifyContent="flex-start" spacing={2} sx={{ position: "relative", zIndex: 2000, margin: "auto", backgroundColor: "white", borderTop: "solid 0.5px #b2b2b2", borderRight: "solid 0.5px #b2b2b2", borderLeft: "solid 0.5px #b2b2b2", }}>
                    {
                        menu == 0 &&
