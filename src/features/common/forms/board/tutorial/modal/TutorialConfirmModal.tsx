...
export default function TutorialConfirmModal({ skip, register }: PageProps) {
        ...
        <Modal open={true} onClose={() => { }} sx={{ zIndex: 3000 }}>
            <Paper sx={modalStyle}>
                <Box sx={{ textAlign: "center", p: 3 }}>
                    ...
                    <Typography variant="body1" sx={{ color: "black", fontSize: 14, pb: 1 }}>
                        試しに戦術アニメーションを作ってみましょう！
                    </Typography>
                </Box>
                <Divider />
                <Stack direction="row" justifyContent="space-between">
                    <Button onClick={skip}>
                        <Typography variant="button" sx={{ mx: "auto", fontWeight: "bold" }} >スキップ</Typography>
                    </Button>
