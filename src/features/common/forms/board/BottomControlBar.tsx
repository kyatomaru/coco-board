...
export default function BottomControlBar({ frame, setFrame, currentFrame, setCurrentFrame, setPlayFrame, isPlay, setIsPlay, tutorialId, setTutorialId }: PageProps) {
    ...
    return (
        <Stack direction="row" justifyContent="space-between" sx={{ position: "relative", zIndex: 2000, px: 2, margin: "auto", backgroundColor: "white", border: "solid 0.5px #b2b2b2", background: "red" }}>
