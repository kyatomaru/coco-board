...
export default function ProblemContentsBar({ contents, EditButtonClick, DeleteButtonClick }: PageProps) {
    ...
    return (
        <Box sx={{ position: 'sticky', top: 0, left: 0, right: 0, backgroundColor: "white", zIndex: 1200 }} >
            <Grid sx={{ px: 1, height: "40px" }} container direction="row" alignItems="center" justifyContent="space-between">
                <Grid>
                    <IconButton onClick={(event) => { contents != undefined && router.push('/problem') }} ><ArrowLeftIcon /></IconButton>
                </Grid>
                <Grid>
