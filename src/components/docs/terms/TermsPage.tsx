        ...
        <Box sx={{ width: "100%", background: "white" }}>
            ...
            <Container sx={{ mt: "90px" }}>
                ...
                <Box sx={{ my: 8 }}>
                    ...
                    <Box sx={{ py: 4 }}>
                        <Typography variant="h2" sx={{ fontSize: "1.9rem", fontWeight: 700, mb: "24px" }}>2. 定義</Typography>
                        <Typography variant="body1" sx={{ fontSize: "1rem", color: "#657786" }}>
                    ...
                    <Box sx={{ py: 4 }}>
                        <Typography variant="h2" sx={{ fontSize: "1.9rem", fontWeight: 700, mb: "24px" }}>3. アカウントの作成と管理</Typography>
                        <Typography variant="body1" sx={{ fontSize: "1rem", color: "#657786" }}>
