...
export default function PracticeEditForm() {
    ...
    const onSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        problemContents.updateDate = new Date();

        const data = { updateData: problemContents, contentsId: String(params.contentsId) }
        ...
        <Box maxWidth="sm" sx={containterStyle}>
            ...
            >
                ...
                <Container maxWidth="sm" sx={{ mt: 2 }}>
                    ...
                    {/* {menu == 1 &&
                        <PracticeForm contents={problemContents} titleError={titleError} />
                    } */}
                </Container>
            </Box>
        </Box >
