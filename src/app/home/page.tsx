    ...
    <main className="flex min-h-screen flex-col items-center justify-between bg-white" style={{ overflow: "hidden", position: "relative" }}>
      ...
      {user !== null &&
        <>
          ...
          <Container maxWidth="md" sx={{ backgroundColor: "#eee", overflowY: "auto", height: "100vh", position: "relative", mx: 0, pt: { xs: "146px", md: "110px" }, px: 0, pl: { md: "120px", lg: "250px" } }}>

            {displayMenu == 0 &&
              <Box sx={{ pt: 2, pb: "270px", borderRadius: 2, px: 2 }}>
