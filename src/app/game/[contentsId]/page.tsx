...
import { GameContentsModel, GameContentsType } from '@/types/game/GameContents';
import { getAuth, onAuthStateChanged } from 'firebase/auth';
import type { User } from 'firebase/auth';
import GameContents from '@/components/viewpage/contents/game/GameContents';
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between bg-white">
      <Container maxWidth="sm" sx={{ ...containterStyle, px: "0 !important", position: "relative" }}>
        <GameContents contents={contents} DeleteContents={DeleteContents} />
      </Container>
      <Footer />
    </main >
  )
